...
namespace
{
class IronPressStandaloneApplication final : public juce::JUCEApplication
{
public:
    IronPressStandaloneApplication()
    {
...
START_JUCE_APPLICATION(IronPressStandaloneApplication)
